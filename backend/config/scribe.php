...
return [
     ...
     */
    'title' => 'Ask Dentist MVP API Documentation',

    /*
     * A short description of your API.
     */
    'description' => 'Comprehensive dental consultation platform API providing secure authentication, consultation management, real-time messaging, and file handling for doctors and patients.',

    /*
     * The base URL displayed in the docs.
     * If this is empty, Scribe will use the value of config('app.url').
     */
    'base_url' => null,

    /*
     * Specify which version of OpenAPI the generated docs should comply with.
     * Can be "2.0" or "3.0.0" or "3.1.0".
     */
    'openapi' => '3.0.0',
     ...
     *   so you can add commits to version control and host it via a URL.
